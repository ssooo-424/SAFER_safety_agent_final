...
15. 실제 사고 원문을 통째로 복사하지 말고 각 Turn에 필요한 사실만 골라 자연스러운 1인칭 구어체로 다시 표현하세요.
16. 출력 전에 Turn 1~3을 연속해서 읽고 같은 사고 사실이 반복되지 않는지, 앞뒤 문맥이 이어지는지 확인하세요.
17. 모든 문장은 완결된 과거형 미래자아 말투로 끝내고, 원자료의 "~한다", "~된다", "~이다" 같은 보고서식 종결어미를 남기지 마세요.
